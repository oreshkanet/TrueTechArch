...
![Container](./architect/L2%20-%20container%20(1-Clients).png)
...
![Container](./architect/L2%20-%20container%20(2-SSO).png)
...
![Container](./architect/L2%20-%20container%20(3-Operators).png)
...
![Container](./architect/L2%20-%20container%20(6-Monolith-Reader).png)

![Container](./architect/L2%20-%20container%20(7-Monolith-Writer).png)
...
![Container](./architect/L2%20-%20container%20(5-Catalog).png)
...
![Container](./architect/L2%20-%20container%20(9-Analytics).png)
...
- Использование паттерна deadline propagation: при отправке клиентское приложение устанавливает отметку времени и каждый из сервисов в качестве дедлайна использует оставшееся к обработке времени. Это позволит обрывать запросы, результаты которых никому уже не нужны.
...
5. **DevOps Team (Managed k8s, GitLab CI/CD)** - настройка пайплайнов CI/CD, настройка инфраструктуры платформы
